...
@section('content')
    ...
    <main class="main">
        <div class="single-page register">
            <div class="single-page__container container">
                <h1 class="single-page__title">Create an account on LogistiQuote</h1>
                <form action="{{ route('register') }}" method="POST" class="single-page__form form" name="register">
                    @csrf
                    <div class="input">
                        <div class="input__holder @error('f_name') error @enderror">
                            <label for="f_name">First name</label>
                            <input type="text" id="f_name" value="" name="f_name" autocomplete="first-name" required>
                    ...
                    <div class="input">
                        <div class="input__holder  @error('l_name') error @enderror">
                            <label for="l_name">Last name</label>
                            <input type="text" value="" id="l_name" name="l_name" required>
                            <button type="button" aria-label="Close"></button>
                        </div>
                        @error('l_name')
                        <p class="errorInputMsg">{{ $message }}</p>
                    ...
                    <div class="input">
                        <label for="role" class="sr-only @error('role') error @enderror">Create account as</label>
                        <select name="role" id="role">
                            <option value="">Create account as</option>
                    ...
                    <div class="input">
                        <label for="country" class="sr-only @error('country') error @enderror"">Select country</label>
                    ...
                    <div class="input">
                        <div class="input__holder @error('phone') error @enderror">
                    ...
                    <div class="input">
                        <div class="input__holder">
                            ...
                            <input type="text" id="company_name" name="company_name" autocomplete="org" required>
                            <button type="button" aria-label="Close"></button>
                        </div>
                        @error('company_name')
                        <p class="errorInputMsg">{{ $message }}</p>

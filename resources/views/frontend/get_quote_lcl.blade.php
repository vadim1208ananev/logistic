    ...
    <div class="shipping-form" style="display: inline-block;">
        <form action="{{ route('form_quote_step2') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="shipment-type" style="margin: 20px 0px;">
                @if(session('data')['transportation_type'] == 'air')
...
.calc-container{
    ...
    gap:131px;
         ...
         <!-- <div class='calc-container' > <div class='title-calc' ><h2>Shipment Calculations</h2></div><div class='delivery-img'><img  src='https://logistiquote.com/image005.png' title='delivery'></div></div>-->

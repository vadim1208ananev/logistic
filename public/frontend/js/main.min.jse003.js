function globalNavDropdowns(e) {
    ...
    this.dropdownRoots.forEach(function (e, i) {
        e.addEventListener(n.end, function (n) {
            n.preventDefault(), n.stopPropagation(), t.toggleDropdown(e)
        }), e.addEventListener(n.enter, function (n) {
            "touch" != n.pointerType && (t.stopCloseTimeout(), t.openDropdown(e))
        }), e.addEventListener(n.leave, function (e) {
            "touch" != e.pointerType && t.startCloseTimeout()
        })
    }), this.dropdownContainer.addEventListener(n.end, function (e) {
        e.stopPropagation()
    }), this.dropdownContainer.addEventListener(n.enter, function (e) {
        "touch" != e.pointerType && t.stopCloseTimeout()
...
function globalNavPopup(e) {
    ...
    var T = function (e) {
        var t, n, i, r, o, s, a, l, c, u, d, f, h, p, m, g, v, y, b, _ = "sizzle" + 1 * new Date,
            w = e.document,
            E = 0,
            C = 0,
            T = le(),
        ...
        function ae(e, t, i, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : w) !== h && f(t), t = t || h, m)) {
                if (11 !== E && (d = J.exec(e)))
                    ...
                    } if (n.qsa && !D[e + " "] && (!g || !g.test(e)) && (1 !== E || "object" !== t.nodeName.toLowerCase())) {
        ...
        for (t in n = ae.support = {}, o = ae.isXML = function (e) {
                ...
                return s !== h && 9 === s.nodeType && s.documentElement && (p = (h = s).documentElement, m = !o(h), w !== h && (r = h.defaultView) && r.top !== r && (r.addEventListener ? r.addEventListener("unload", oe, !1) : r.attachEvent && r.attachEvent("onunload", oe)), n.attributes = ue(function (e) {
                ...
                if ((e.ownerDocument || e) !== h && f(e), n.matchesSelector && m && !D[t + " "] && (!v || !v.test(t)) && (!g || !g.test(t))) try {
                    var i = y.call(e, t);
                    ...
                    CHILD: function (e, t, n, i, r) {
                        ...
                        return 1 === i && 0 === r ? function (e) {
                            ...
                            if (g) {
                                ...
                                } else if (y && (b = h = (c = (u = (d = (f = t)[_] || (f[_] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === E && c[1]), !1 === b)
                                    for (;
                                        (f = ++h && f && f[m] || (b = h = 0) || p.pop()) && ((a ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++b || (y && ((u = (d = f[_] || (f[_] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [E, b]), f !== t)););
        ...
        function Ce(e, t, n, i, r, o) {
            return i && !i[_] && (i = Ce(i)), r && !r[_] && (r = Ce(r, o)), ce(function (o, s, a, l) {
                var c, u, d, f = [],
                    h = [],
                    p = s.length,
                    m = o || function (e, t, n) {
                    ...
                    g = !e || !o && t ? m : Ee(m, f, e, a, l),
                    v = n ? r || (o ? e : p || i) ? [] : s : g;
                if (n && n(g, v, a, l), i)
                    for (c = Ee(v, h), i(c, [], a, l), u = c.length; u--;)(d = c[u]) && (v[h[u]] = !(g[h[u]] = d));
                if (o) {
                    if (r || e) {
                        if (r) {
                        ...
                        for (u = v.length; u--;)(d = v[u]) && -1 < (c = r ? P(o, d) : f[u]) && (o[c] = !(s[c] = d))
                    }
            ...
            for (var t, n, r, o = e.length, s = i.relative[e[0].type], a = s || i.relative[" "], l = s ? 1 : 0, u = _e(function (e) {
                ...
                if (n = i.relative[e[l].type]) f = [_e(we(f), n)];
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[_]) {
                        ...
                        return Ce(1 < l && we(f), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
        ...
        return ye.prototype = i.filters = i.pseudos, i.setFilters = new ye, s = ae.tokenize = function (e, t) {
            ...
            var n, r, o, a, l, u, d = [],
                ...
                g = S[e + " "];
            if (!g) {
                for (t || (t = s(e)), n = t.length; n--;)(g = Te(t[n]))[_] ? d.push(g) : p.push(g);
                (g = S(e, (r = p, a = 0 < (o = d).length, l = 0 < r.length, u = function (e, t, n, s, u) {
                    var d, p, g, v = 0,
                        y = "0",
                        b = e && [],
                        _ = [],
                        ...
                        x = C.length;
                    for (u && (c = t === h || t || u); y !== x && null != (d = C[y]); y++) {
                        if (l && d) {
                            for (p = 0, t || d.ownerDocument === h || (f(d), n = !m); g = r[p++];)
                                if (g(d, t || h, n)) {
                                    s.push(d);
                                    break
                                } u && (E = T)
        ...
        }, n.sortStable = _.split("").sort(A).join("") === _, n.detectDuplicates = !!d, f(), n.sortDetached = ue(function (e) {
    ...
    w.Callbacks = function (e) {
                ...
                r = {
                    ...
                    then: function (t, i, r) {
                                ...
                                var a = this,
                                    ...
                                    c = function () {
                                        ...
                                        if (!(t < o)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, m(c) ? r ? c.call(e, s(o, n, R, r), s(o, n, q, r)) : (o++, c.call(e, s(o, n, R, r), s(o, n, q, r), s(o, n, R, n.notifyWith))) : (i !== R && (a = void 0, l = [e]), (r || n.resolveWith)(a, l))
                                        }
                                    },
                                    u = r ? c : function () {
                                        try {
                        ...
                        return w.Deferred(function (e) {
                            n[0][3].add(s(0, e, m(r) ? r : R, e.notifyWith)), n[1][3].add(s(0, e, m(t) ? t : R)), n[2][3].add(s(0, e, m(i) ? i : q))
                        }).promise()
                    },
                    promise: function (e) {
        ...
        when: function (e) {
            ...
            if (t <= 1 && (M(e, s.done(a(n)).resolve, s.reject, !t), "pending" === s.state() || m(r[n] && r[n].then))) return s.then();
    ...
    w.fn.ready = function (e) {
        ...
        readyWait: 1,
        ready: function (e) {
            (!0 === e ? --w.readyWait : w.isReady) || (w.isReady = !0) !== e && 0 < --w.readyWait || B.resolveWith(i, [w])
        }
    }), w.ready.then = B.then, "complete" === i.readyState || "loading" !== i.readyState && !i.documentElement.doScroll ? e.setTimeout(w.ready) : (i.addEventListener("DOMContentLoaded", W), e.addEventListener("load", W));
    ...
    function de(e, t) {
        for (var n, i, r, o, s, a, l, c = [], u = 0, d = e.length; u < d; u++)(i = e[u]).style && (n = i.style.display, t ? ("none" === n && (c[u] = Y.get(i, "display") || null, c[u] || (i.style.display = "")), "" === i.style.display && ae(i) && (c[u] = (l = s = o = void 0, s = (r = i).ownerDocument, a = r.nodeName, (l = ue[a]) || (o = s.body.appendChild(s.createElement(a)), l = w.css(o, "display"), o.parentNode.removeChild(o), "none" === l && (l = "block"), ue[a] = l)))) : "none" !== n && (c[u] = "none", Y.set(i, "display", n)));
    ...
    function we(e, t, n, i, r) {
        for (var o, s, a, l, c, u, d = t.createDocumentFragment(), f = [], h = 0, p = e.length; h < p; h++)
            ...
            for (s = s || d.appendChild(t.createElement("div")), a = (he.exec(o) || ["", ""])[1].toLowerCase(), l = me[a] || me._default, s.innerHTML = l[1] + w.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
            w.merge(f, s.childNodes), (s = d.firstChild).textContent = ""
        } else f.push(t.createTextNode(o));
        for (d.textContent = "", h = 0; o = f[h++];)
            if (i && -1 < w.inArray(o, i)) r && r.push(o);
            else if (c = oe(o), s = ge(d.appendChild(o), "script"), c && ve(s), n)
    ...
    w.event = {
        ...
        add: function (e, t, n, i, r) {
            var o, s, a, l, c, u, d, f, h, p, m, g = Y.get(e);
            if (g)
                for (n.handler && (n = (o = n).handler, r = o.selector), r && w.find.matchesSelector(re, r), n.guid || (n.guid = w.guid++), (l = g.events) || (l = g.events = {}), (s = g.handle) || (s = g.handle = function (t) {
                        return void 0 !== w && w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
                    }), c = (t = (t || "").match(H) || [""]).length; c--;) h = m = (a = Te.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), h && (d = w.event.special[h] || {}, h = (r ? d.delegateType : d.bindType) || h, d = w.event.special[h] || {}, u = w.extend({
                    type: h,
                    origType: m,
                    data: i,
                    handler: n,
        ...
        remove: function (e, t, n, i, r) {
            var o, s, a, l, c, u, d, f, h, p, m, g = Y.hasData(e) && Y.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match(H) || [""]).length; c--;)
                    if (h = m = (a = Te.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), h) {
                        for (d = w.event.special[h] || {}, f = l[h = (i ? d.delegateType : d.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;) u = f[o], !r && m !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
        ...
        special: {
            ...
            click: {
                setup: function (e) {
                    var t = this || e;
                    return fe.test(t.type) && t.click && A(t, "input") && Ne(t, "click", xe), !1
                },
                trigger: function (e) {
                    var t = this || e;
    ...
    function qe(e, t, n, i) {
        ...
        var r, o, a, l, c, u, d = 0,
            ...
            g = t[0],
            v = m(g);
        if (v || 1 < f && "string" == typeof g && !p.checkClone && Le.test(g)) return e.each(function (r) {
            var o = e.eq(r);
            v && (t[0] = g.call(this, r, o.html())), qe(o, t, n, i)
        });
        if (f && (o = (r = we(t, e[0].ownerDocument, !1, e, i)).firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (l = (a = w.map(ge(r, "script"), Pe)).length; d < f; d++) c = r, d !== h && (c = w.clone(c, !0, !0), l && w.merge(a, ge(c, "script"))), n.call(e[d], c, d);
            if (l)
                for (u = a[a.length - 1].ownerDocument, w.map(a, He), d = 0; d < l; d++) c = a[d], pe.test(c.type || "") && !Y.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
    ...
    function Me(e, t, n) {
        for (var i, r = t ? w.filter(t, e) : e, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || w.cleanData(ge(i)), i.parentNode && (n && oe(i) && ve(ge(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    w.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(p.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e)))
                for (s = ge(u), i = 0, r = (o = ge(e)).length; i < r; i++) a = o[i], "input" === (c = (l = s[i]).nodeName.toLowerCase()) && fe.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
            if (t)
                if (n)
        ...
        html: function (e) {
            return $(this, function (e) {
                ...
                if ("string" == typeof e && !Ie.test(e) && !me[(he.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = w.htmlPrefilter(e);
                    try {
    ...
    function $e(e, t, n) {
        ...
        return (n = n || Be(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || oe(e) || (s = w.style(e, t)), !p.pixelBoxStyles() && Fe.test(s) && We.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    function Ke(e) {
        return w.cssProps[e] || Qe[e] || (e in Ve ? e : Qe[e] = function (e) {
    ...
    w.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, o, s, a = Q(t),
                    l = Ye.test(t),
                    c = e.style;
                if (l || (t = Ke(a)), s = w.cssHooks[t] || w.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
        ...
        css: function (e, t, n, i) {
            var r, o, s, a = Q(t);
            return Ye.test(t) || (t = Ke(a)), (s = w.cssHooks[t] || w.cssHooks[a]) && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = $e(e, t, i)), "normal" === r && t in Ze && (r = Ze[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
        ...
        w.cssHooks[t] = {
            ...
            set: function (e, n, i) {
                var r, o = Be(e),
                    ...
                    l = i ? et(e, t, i, a, o) : 0;
                return a && s && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - et(e, t, "border", !1, o) - .5)), l && (r = ne.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = w.css(e, t)), Je(0, n, l)
            }
        }
    ...
    function ht(e, t, n) {
        ...
        for (function (e, t) {
            ...
            if (i = ht.prefilters[o].call(c, e, u, c.opts)) return m(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
    ...
    w.Animation = w.extend(ht, {
        ...
        prefilters: [function (e, t, n) {
            ...
            for (i in n.queue || (null == (s = w._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, a = s.empty.fire, s.empty.fire = function () {
                ...
                for (i in d && 1 === e.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = g && g.display) && (c = Y.get(e, "display")), "none" === (u = w.css(e, "display")) && (c ? u = c : (de([e], !0), c = e.style.display || c, u = w.css(e, "display"), de([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === w.css(e, "float") && (l || (f.done(function () {
                        p.display = c
                    ...
                    for (i in m || de([e]), Y.remove(e, "fxshow"), h) w.style(e, i, h[i])
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, o) {
            ...
            if (a = p = l = r = r || i, 3 !== r.nodeType && 8 !== r.nodeType && !Et.test(y + w.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(), b.sort()), u = y.indexOf(":") < 0 && "on" + y, (t = t[w.expando] ? t : new w.Event(y, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = b.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + b.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), h = w.event.special[y] || {}, o || !h.trigger || !1 !== h.trigger.apply(r, n))) {
                if (!o && !h.noBubble && !g(r)) {
                    for (c = h.delegateType || y, Et.test(c + y) || (a = a.parentNode); a; a = a.parentNode) v.push(a), l = a;
                    l === (r.ownerDocument || i) && v.push(l.defaultView || l.parentWindow || e)
                }
                for (s = 0;
                    (a = v[s++]) && !t.isPropagationStopped();) p = a, t.type = 1 < s ? c : h.bindType || y, (f = (Y.get(a, "events") || {})[t.type] && Y.get(a, "handle")) && f.apply(a, n), (f = u && a[u]) && f.apply && K(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
                return t.type = y, o || t.isDefaultPrevented() || h._default && !1 !== h._default.apply(v.pop(), n) || !K(r) || u && m(r[y]) && !g(r) && ((l = r[u]) && (r[u] = null), w.event.triggered = y, t.isPropagationStopped() && p.addEventListener(y, Ct), r[y](), t.isPropagationStopped() && p.removeEventListener(y, Ct), w.event.triggered = void 0, l && (r[u] = l)), t.result
            }
        },
    ...
    function It(e, t, n, i) {
        ...
        if (Array.isArray(t)) w.each(t, function (t, r) {
            n || Dt.test(e) ? i(e, r) : It(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
        });
    ...
    w.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !w(this).is(":disabled") && kt.test(this.nodeName) && !Nt.test(e) && (this.checked || !fe.test(e))
            }).map(function (e, t) {
                var n = w(this).val();
    ...
    Bt.href = Tt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            if (v.promise(T), p.url = ((t || p.url || Tt.href) + "").replace(Rt, Tt.protocol + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = (p.dataType || "*").toLowerCase().match(H) || [""], null == p.crossDomain) {
                c = i.createElement("a");
                try {
            ...
            if (p.data && p.processData && "string" != typeof p.data && (p.data = w.param(p.data, p.traditional)), $t(qt, p, n, T), u) return T;
            for (f in (d = w.event && p.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Ht.test(p.type), o = p.url.replace(Ot, ""), p.hasContent ? p.data && p.processData && 0 === (p.contentType || "").indexOf("application/x-www-form-urlencoded") && (p.data = p.data.replace(Lt, "+")) : (h = p.url.slice(o.length), p.data && (p.processData || "string" == typeof p.data) && (o += (St.test(o) ? "&" : "?") + p.data, delete p.data), !1 === p.cache && (o = o.replace(jt, "$1"), h = (St.test(o) ? "&" : "?") + "_=" + xt++ + h), p.url = o + h), p.ifModified && (w.lastModified[o] && T.setRequestHeader("If-Modified-Since", w.lastModified[o]), w.etag[o] && T.setRequestHeader("If-None-Match", w.etag[o])), (p.data && p.hasContent && !1 !== p.contentType || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Ft + "; q=0.01" : "") : p.accepts["*"]), p.headers) T.setRequestHeader(f, p.headers[f]);
            if (p.beforeSend && (!1 === p.beforeSend.call(m, T, p) || u)) return T.abort();
            if (C = "abort", y.add(p.complete), T.done(p.success), T.fail(p.error), r = $t(Mt, p, n, T)) {
    ...
    p.cors = !!Vt && "withCredentials" in Vt, p.ajax = Vt = !!Vt, w.ajaxTransport(function (t) {
        var n, i;
    ...
    w.ajaxSetup({
        ...
        jsonpCallback: function () {
            var e = Kt.pop() || w.expando + "_" + xt++;
            return this[e] = !0, e
        }
    }), w.ajaxPrefilter("json jsonp", function (t, n, i) {
        var r, o, s, a = !1 !== t.jsonp && (Xt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(t.data) && "data");
        if (a || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = m(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Xt, "$1" + r) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            return s || w.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === o ? w(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Kt.push(r)), s && m(o) && o(s[0]), s = o = void 0
        }), "script"
        ...
        var i, r, o, s = this,
            a = e.indexOf(" ");
        return -1 < a && (i = yt(e.slice(a)), e = e.slice(0, a)), m(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), 0 < s.length && w.ajax({
            url: e,
            type: r || "GET",
            dataType: "html",
            data: t
    ...
    }, w.isArray = Array.isArray, w.parseJSON = JSON.parse, w.nodeName = A, w.isFunction = m, w.isWindow = g, w.camelCase = Q, w.type = b, w.now = Date.now, w.isNumeric = function (e) {
        var t = w.type(e);
...
function (e, t) {
    ...
    t(document).on(f.CLICK_DATA_API, '[data-dismiss="alert"]', h._handleDismiss(new h)), t.fn[l] = h._jQueryInterface, t.fn[l].Constructor = h, t.fn[l].noConflict = function () {
        return t.fn[l] = d, h._jQueryInterface
    };
    var p = "button",
        m = "bs.button",
        g = "." + m,
    ...
    t(document).on(C.CLICK_DATA_API, _, function (e) {
        var n = e.target;
        if (t(n).hasClass("btn") || (n = t(n).closest(E)[0]), !n || n.hasAttribute("disabled") || n.classList.contains("disabled")) e.preventDefault();
        else {
    ...
    var x = "carousel",
        ...
        M = function () {
            ...
            return n.next = function () {
                ...
                t(this._element).off(D), t.removeData(this._element, S), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
            }, n._getConfig = function (e) {
                return e = o({}, k, {}, e), a.typeCheckConfig(x, e, I), e
                ...
                if (o = e === L ? (i = "carousel-item-left", r = "carousel-item-next", "left") : (i = "carousel-item-right", r = "carousel-item-prev", "right"), u && t(u).hasClass(P)) this._isSliding = !1;
                    ...
                    if (t(this._element).hasClass("slide")) {
                        ...
                        t(l).one(a.TRANSITION_END, function () {
                            t(u).removeClass(i + " " + r).addClass(P), t(l).removeClass(P + " " + r + " " + i), s._isSliding = !1, setTimeout(function () {
                                return t(s._element).trigger(h)
                            }, 0)
                        }).emulateTransitionEnd(m)
                    } else t(l).removeClass(P), t(u).addClass(P), this._isSliding = !1, t(this._element).trigger(h);
                    f && this.cycle()
                }
            }, e._jQueryInterface = function (n) {
                return this.each(function () {
            ...
            return n.toggle = function () {
                ...
                if (!(this._isTransitioning || t(this._element).hasClass(Q) || (this._parent && 0 === (n = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function (e) {
                    ...
                    if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                        ...
                        t(this._element).removeClass(K).addClass(X), this._element.style[s] = 0, this._triggerArray.length && t(this._triggerArray).removeClass(Y).attr("aria-expanded", !0), this.setTransitioning(!0);
                        var l = "scroll" + (s[0].toUpperCase() + s.slice(1)),
                            c = a.getTransitionDurationFromElement(this._element);
                        t(this._element).one(a.TRANSITION_END, function () {
                            t(r._element).removeClass(X).addClass(K).addClass(Q), r._element.style[s] = "", r.setTransitioning(!1), t(r._element).trigger(V.SHOWN)
                ...
                if (!this._isTransitioning && t(this._element).hasClass(Q)) {
                    ...
                    if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        this._element.style[i] = this._element.getBoundingClientRect()[i] + "px", a.reflow(this._element), t(this._element).addClass(X).removeClass(K).removeClass(Q);
                        var r = this._triggerArray.length;
                        if (0 < r)
                            for (var o = 0; o < r; o++) {
                                var s = this._triggerArray[o],
                                    l = a.getSelectorFromElement(s);
                                null !== l && (t([].slice.call(document.querySelectorAll(l))).hasClass(Q) || t(s).addClass(Y).attr("aria-expanded", !1))
                            }
                        this.setTransitioning(!0), this._element.style[i] = "";
                        var c = a.getTransitionDurationFromElement(this._element);
                        t(this._element).one(a.TRANSITION_END, function () {
                            e.setTransitioning(!1), t(e._element).removeClass(X).addClass(K).trigger(V.HIDDEN)
                ...
                return (e = o({}, U, {}, e)).toggle = Boolean(e.toggle), a.typeCheckConfig(F, e, z), e
                ...
                return this.each(function () {
                    ...
                    if (!r && s.toggle && /show|hide/.test(n) && (s.toggle = !1), r || (r = new e(this, s), i.data(B, r)), "string" == typeof n) {
    ...
    t(document).on(V.CLICK_DATA_API, G, function (e) {
        ...
        return t.fn[F] = $, Z._jQueryInterface
    };
    var J = "undefined" != typeof window && "undefined" != typeof document && "undefined" != typeof navigator,
        ...
        te = J && window.Promise ? function (e) {
            var t = !1;
            return function () {
    ...
    var ae = J && !(!window.MSInputMethodContext || !document.documentMode),
        le = J && /MSIE 10/.test(navigator.userAgent);
    ...
    function ue(e) {
        ...
        for (var t = ce(10) ? document.body : null, n = e.offsetParent || null; n === t && e.nextElementSibling;) n = (e = e.nextElementSibling).offsetParent;
        var i = n && n.nodeName;
    ...
    function fe(e, t) {
        ...
        var a = de(e);
        return a.host ? fe(a.host, t) : fe(e, de(t).host)
    }
    ...
    function ge(e) {
        ...
        return {
            height: me("Height", t, n, i),
            width: me("Width", t, n, i)
        }
    }
    ...
    function we(e) {
        ...
        if (l || c) {
            var u = ie(e);
            l -= pe(u, "x"), c -= pe(u, "y"), r.width -= l, r.height -= c
        }
        return _e(r)
    }
    ...
    function Ee(e, t, n) {
        ...
        if (f.marginTop = 0, f.marginLeft = 0, !r && o) {
            ...
            f.top -= u - h, f.bottom -= u - h, f.left -= d - p, f.right -= d - p, f.marginTop = h, f.marginLeft = p
        }
    ...
    function Se(e, t, n, i) {
        ...
        return Ee(n, r ? Ce(t) : fe(t, se(n)), r)
    }
    ...
    function He(e, t) {
        Object.keys(t).forEach(function (n) {
            var i = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(n) && Pe(t[n]) && (i = "px"), e.style[n] = t[n] + i
        })
    }
    var Re = J && /Firefox/i.test(navigator.userAgent);
            ...
            modifiers: {
                ...
                offset: {
                    ...
                    fn: function (e, t) {
                        var n, i = t.offset,
                            ...
                            a = o.reference,
                            l = r.split("-")[0];
                        return n = Pe(+i) ? [+i, 0] : function (e, t, n, i) {
                            var r = [0, 0],
                    ...
                    fn: function (e, t) {
                        ...
                        var c = t.priority,
                            ...
                            d = {
                                primary: function (e) {
                                    var n = u[e];
                                    return u[e] < l[e] && !t.escapeWithReference && (n = Math.max(u[e], l[e])), ye({}, e, n)
                                },
                                secondary: function (e) {
                                    var n = "right" === e ? "left" : "top",
                                        i = u[n];
                                    return u[e] > l[e] && !t.escapeWithReference && (i = Math.min(u[n], l[e] - ("right" === e ? u.width : u.height))), ye({}, n, i)
                                }
                            };
                ...
                arrow: {
                    ...
                    fn: function (e, t) {
                        ...
                        var r = e.placement.split("-")[0],
                            ...
                            h = l ? "bottom" : "right",
                            p = De(i)[c];
                        a[h] - p < s[d] && (e.offsets.popper[d] -= s[d] - (a[h] - p)), a[d] + p > s[h] && (e.offsets.popper[d] += a[d] + p - s[h]), e.offsets.popper = _e(e.offsets.popper);
                        var m = a[d] + a[c] / 2 - p / 2,
                            g = ie(e.instance.popper),
                            v = parseFloat(g["margin" + u], 10),
                            y = parseFloat(g["border" + u + "Width"], 10),
                            b = m - e.offsets.popper[d] - v - y;
                        return b = Math.max(Math.min(s[c] - p, b), 0), e.arrowElement = i, e.offsets.arrow = (ye(n = {}, d, Math.round(b)), ye(n, f, ""), n), e
                    },
                    element: "[x-arrow]"
                },
                flip: {
                    ...
                    fn: function (e, t) {
                        ...
                        return s.forEach(function (a, l) {
                            ...
                            var c = e.offsets.popper,
                                ...
                                w = b || _;
                            (f || v || w) && (e.flipped = !0, (f || v) && (i = s[l + 1]), w && (o = "end" === o ? "start" : "start" === o ? "end" : o), e.placement = i + (o ? "-" + o : ""), e.offsets.popper = be({}, e.offsets.popper, Ne(e.instance.popper, e.offsets.reference, e.placement)), e = Ie(e.instance.modifiers, e, "flip"))
                        }), e
                    },
                    behavior: "flip",
                    padding: 5,
                ...
                inner: {
                    ...
                    fn: function (e) {
                        ...
                        return r[s ? "left" : "top"] = o[n] - (a ? r[s ? "width" : "height"] : 0), e.placement = Ae(t), e.offsets.popper = _e(r), e
                    }
                },
                hide: {
                    order: 800,
                ...
                computeStyle: {
                    ...
                    fn: function (e, t) {
                        ...
                        return e.attributes = be({}, y, e.attributes), e.styles = be({}, d, e.styles), e.arrowStyles = be({}, e.offsets.arrow, e.arrowStyles), e
                    },
                    gpuAcceleration: !0,
                    x: "bottom",
                    y: "right"
            ...
            value: function () {
                return function () {
                    if (!this.state.isDestroyed) {
                        ...
                        e.offsets.reference = Se(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = xe(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = Ne(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = Ie(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                    }
                }.call(this)
            }
        }, {
    ...
    function Ue(e, t) {
        ...
        ! function (e, t) {
            if (!(e instanceof Ue)) throw new TypeError("Cannot call a class as a function")
        }(this), this.scheduleUpdate = function () {
            return requestAnimationFrame(n.update)
        }, this.update = te(this.update.bind(this)), this.options = be({}, Ue.Defaults, i), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(be({}, Ue.Defaults.modifiers, i.modifiers)).forEach(function (e) {
            n.options.modifiers[e] = be({}, Ue.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {})
    ...
    $e.Utils = ("undefined" != typeof window ? window : global).PopperUtils, $e.placements = Me, $e.Defaults = We;
    var ze = "dropdown",
        Ve = "bs.dropdown",
        Qe = "." + Ve,
        Ke = ".data-api",
        ...
        Ge = {
            ...
            SHOWN: "shown" + Qe,
            CLICK: "click" + Qe,
            CLICK_DATA_API: "click" + Qe + Ke,
            KEYDOWN_DATA_API: "keydown" + Qe + Ke,
            KEYUP_DATA_API: "keyup" + Qe + Ke
        },
        Ze = "disabled",
        Je = "show",
        ...
        ot = function () {
            ...
            var n = e.prototype;
            return n.toggle = function () {
                if (!this._element.disabled && !t(this._element).hasClass(Ze)) {
                    var n = t(this._menu).hasClass(Je);
                    e._clearMenus(), n || this.show(!0)
                }
            }, n.show = function (n) {
                if (void 0 === n && (n = !1), !(this._element.disabled || t(this._element).hasClass(Ze) || t(this._menu).hasClass(Je))) {
                    var i = {
                    ...
                    if (t(o).trigger(r), !r.isDefaultPrevented()) {
                        if (!this._inNavbar && n) {
                            ...
                            var s = this._element;
                            "parent" === this._config.reference ? s = o : a.isElement(this._config.reference) && (s = this._config.reference, void 0 !== this._config.reference.jquery && (s = this._config.reference[0])), "scrollParent" !== this._config.boundary && t(o).addClass("position-static"), this._popper = new $e(s, this._menu, this._getPopperConfig())
                        }
                        "ontouchstart" in document.documentElement && 0 === t(o).closest(".navbar-nav").length && t(document.body).children().on("mouseover", null, t.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), t(this._menu).toggleClass(Je), t(o).toggleClass(Je).trigger(t.Event(Ge.SHOWN, i))
                    }
                }
            }, n.hide = function () {
                if (!this._element.disabled && !t(this._element).hasClass(Ze) && t(this._menu).hasClass(Je)) {
                    var n = {
                            relatedTarget: this._element
                        },
                        i = t.Event(Ge.HIDE, n),
                        r = e._getParentFromElement(this._element);
                    t(r).trigger(i), i.isDefaultPrevented() || (this._popper && this._popper.destroy(), t(this._menu).toggleClass(Je), t(r).toggleClass(Je).trigger(t.Event(Ge.HIDDEN, n)))
                }
            }, n.dispose = function () {
                t.removeData(this._element, Ve), t(this._element).off(Qe), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
            }, n.update = function () {
                ...
                return e = o({}, this.constructor.Default, {}, t(this._element).data(), {}, e), a.typeCheckConfig(ze, e, this.constructor.DefaultType), e
                ...
                var e = t(this._element.parentNode),
                    n = "bottom-start";
                return e.hasClass("dropup") ? (n = "top-start", t(this._menu).hasClass(et) && (n = "top-end")) : e.hasClass("dropright") ? n = "right-start" : e.hasClass("dropleft") ? n = "left-start" : t(this._menu).hasClass(et) && (n = "bottom-end"), n
                    ...
                    for (var i = [].slice.call(document.querySelectorAll(tt)), r = 0, o = i.length; r < o; r++) {
                        ...
                        if (n && "click" === n.type && (l.clickEvent = n), a) {
                            ...
                            if (t(s).hasClass(Je) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && t.contains(s, n.target))) {
                                ...
                                t(s).trigger(u), u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), i[r].setAttribute("aria-expanded", "false"), a._popper && a._popper.destroy(), t(c).removeClass(Je), t(s).removeClass(Je).trigger(t.Event(Ge.HIDDEN, l)))
                            }
                        }
                    }
                ...
                if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(nt).length)) : Ye.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(Ze))) {
    ...
    t(document).on(Ge.KEYDOWN_DATA_API, tt, ot._dataApiKeydownHandler).on(Ge.KEYDOWN_DATA_API, nt, ot._dataApiKeydownHandler).on(Ge.CLICK_DATA_API + " " + Ge.KEYUP_DATA_API, ot._clearMenus).on(Ge.CLICK_DATA_API, tt, function (e) {
        e.preventDefault(), e.stopPropagation(), ot._jQueryInterface.call(t(this), "toggle")
    }).on(Ge.CLICK_DATA_API, ".dropdown form", function (e) {
        e.stopPropagation()
    }), t.fn[ze] = ot._jQueryInterface, t.fn[ze].Constructor = ot, t.fn[ze].noConflict = function () {
        return t.fn[ze] = Xe, ot._jQueryInterface
    };
    var st = "modal",
        at = "bs.modal",
        lt = "." + at,
        ...
        _t = function () {
            function e(e, t) {
                this._config = this._getConfig(t), this._element = e, this._dialog = e.querySelector(vt), this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._isTransitioning = !1, this._scrollbarWidth = 0
            }
            var n = e.prototype;
            return n.toggle = function (e) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var i = t.Event(ft.SHOW, {
                        relatedTarget: e
                    });
                    t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(ft.CLICK_DISMISS, '[data-dismiss="modal"]', function (e) {
                        return n.hide(e)
                    }), t(this._dialog).on(ft.MOUSEDOWN_DISMISS, function () {
                        t(n._element).one(ft.MOUSEUP_DISMISS, function (e) {
                ...
                if (e && e.preventDefault(), this._isShown && !this._isTransitioning) {
                    var i = t.Event(ft.HIDE);
                    if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        this._isShown = !1;
                        var r = t(this._element).hasClass(pt);
                        if (r && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), t(document).off(ft.FOCUSIN), t(this._element).removeClass(mt), t(this._element).off(ft.CLICK_DISMISS), t(this._dialog).off(ft.MOUSEDOWN_DISMISS), r) {
                ...
                [window, this._element, this._dialog].forEach(function (e) {
                    return t(e).off(lt)
                }), t(document).off(ft.FOCUSIN), t.removeData(this._element, at), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
            }, n.handleUpdate = function () {
                this._adjustDialog()
            }, n._getConfig = function (e) {
                return e = o({}, ut, {}, e), a.typeCheckConfig(st, e, dt), e
            }, n._triggerBackdropTransition = function () {
                var e = this;
                if ("static" === this._config.backdrop) {
                    var n = t.Event(ft.HIDE_PREVENTED);
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), t(this._dialog).hasClass("modal-dialog-scrollable") && r ? r.scrollTop = 0 : this._element.scrollTop = 0, i && a.reflow(this._element), t(this._element).addClass(mt), this._config.focus && this._enforceFocus();
                var s = t.Event(ft.SHOWN, {
                    relatedTarget: e
                });
                if (i) {
                ...
                var e = this;
                t(document).off(ft.FOCUSIN).on(ft.FOCUSIN, function (n) {
                    document !== n.target && e._element !== n.target && 0 === t(e._element).has(n.target).length && e._element.focus()
                })
            }, n._setEscapeEvent = function () {
                var e = this;
                this._isShown && this._config.keyboard ? t(this._element).on(ft.KEYDOWN_DISMISS, function (t) {
                    27 === t.which && e._triggerBackdropTransition()
                }) : this._isShown || t(this._element).off(ft.KEYDOWN_DISMISS)
            }, n._setResizeEvent = function () {
                var e = this;
                this._isShown ? t(window).on(ft.RESIZE, function (t) {
                    return e.handleUpdate(t)
                }) : t(window).off(ft.RESIZE)
            }, n._hideModal = function () {
                var e = this;
                this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function () {
                    t(document.body).removeClass(ht), e._resetAdjustments(), e._resetScrollbar(), t(e._element).trigger(ft.HIDDEN)
                })
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), t(this._backdrop).appendTo(document.body), t(this._element).on(ft.CLICK_DISMISS, function (e) {
                            n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : e.target === e.currentTarget && n._triggerBackdropTransition()
                        }), i && a.reflow(this._backdrop), t(this._backdrop).addClass(mt), !e) return;
                    if (!i) return void e();
                    var r = a.getTransitionDurationFromElement(this._backdrop);
                    t(this._backdrop).one(a.TRANSITION_END, e).emulateTransitionEnd(r)
                } else if (!this._isShown && this._backdrop) {
                    t(this._backdrop).removeClass(mt);
                    var o = function () {
                ...
                return this.each(function () {
                    ...
                    if (r || (r = new e(this, s), t(this).data(at, r)), "string" == typeof n) {
                        if (void 0 === r[n]) throw new TypeError('No method named "' + n + '"');
                        r[n](i)
    ...
    t(document).on(ft.CLICK_DATA_API, '[data-toggle="modal"]', function (e) {
        var n, i = this,
            r = a.getSelectorFromElement(this);
        r && (n = document.querySelector(r));
        var s = t(n).data(at) ? "toggle" : o({}, t(n).data(), {}, t(this).data());
        "A" !== this.tagName && "AREA" !== this.tagName || e.preventDefault();
        var l = t(n).one(ft.SHOW, function (e) {
            e.isDefaultPrevented() || l.one(ft.HIDDEN, function () {
                t(i).is(":visible") && i.focus()
            })
        });
        _t._jQueryInterface.call(t(n), s, this)
    }), t.fn[st] = _t._jQueryInterface, t.fn[st].Constructor = _t, t.fn[st].noConflict = function () {
        return t.fn[st] = ct, _t._jQueryInterface
    };
        ...
        for (var i = (new window.DOMParser).parseFromString(e, "text/html"), r = Object.keys(t), o = [].slice.call(i.body.querySelectorAll("*")), s = function (e) {
                ...
                s.forEach(function (e) {
                    ! function (e, t) {
                        ...
                        if (-1 !== t.indexOf(n)) return -1 === wt.indexOf(n) || Boolean(e.nodeValue.match(Et) || e.nodeValue.match(Ct));
            ...
            return n.enable = function () {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        if (t(this.getTipElement()).hasClass(qt)) return void this._leave(null, this);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    o.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation && t(o).addClass(Rt);
                    var l = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
                        c = this._getAttachment(l);
                    this.addAttachmentClass(c);
                    var u = this._getContainer();
                    t(o).data(this.constructor.DATA_KEY, this), t.contains(this.element.ownerDocument.documentElement, this.tip) || t(o).appendTo(u), t(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new $e(this.element, o, this._getPopperConfig(c)), t(o).addClass(qt), "ontouchstart" in document.documentElement && t(document.body).children().on("mouseover", null, t.noop);
                    var d = function () {
                ...
                function n() {
                    i._hoverState !== Pt && r.parentNode && r.parentNode.removeChild(r), i._cleanTipClass(), i.element.removeAttribute("aria-describedby"), t(i.element).trigger(i.constructor.Event.HIDDEN), null !== i._popper && i._popper.destroy(), e && e()
                }
                var i = this,
                    r = this.getTipElement(),
                    o = t.Event(this.constructor.Event.HIDE);
                if (t(this.element).trigger(o), !o.isDefaultPrevented()) {
                    if (t(r).removeClass(qt), "ontouchstart" in document.documentElement && t(document.body).children().off("mouseover", null, t.noop), this._activeTrigger.click = !1, this._activeTrigger[Ft] = !1, this._activeTrigger[Mt] = !1, t(this.tip).hasClass(Rt)) {
                ...
                this.setElementContent(t(e.querySelectorAll(".tooltip-inner")), this.getTitle()), t(e).removeClass(Rt + " " + qt)
            }, n.setElementContent = function (e, n) {
                "object" != typeof n || !n.nodeType && !n.jquery ? this.config.html ? (this.config.sanitize && (n = Tt(n, this.config.whiteList, this.config.sanitizeFn)), e.html(n)) : e.text(n) : this.config.html ? t(n).parent().is(e) || e.empty().append(n) : e.text(t(n).text())
            }, n.getTitle = function () {
                ...
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusin" === e.type ? Ft : Mt] = !0), t(n.getTipElement()).hasClass(qt) || n._hoverState === Pt ? n._hoverState = Pt : (clearTimeout(n._timeout), n._hoverState = Pt, n.config.delay && n.config.delay.show ? n._timeout = setTimeout(function () {
                    n._hoverState === Pt && n.show()
                }, n.config.delay.show) : n.show())
            }, n._leave = function (e, n) {
                var i = this.constructor.DATA_KEY;
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)), e && (n._activeTrigger["focusout" === e.type ? Ft : Mt] = !1), n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = "out", n.config.delay && n.config.delay.hide ? n._timeout = setTimeout(function () {
                ...
                return Object.keys(n).forEach(function (e) {
                    ...
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), a.typeCheckConfig(xt, e, this.constructor.DefaultType), e.sanitize && (e.template = Tt(e.template, e.whiteList, e.sanitizeFn)), e
                ...
                return this.each(function () {
                    var i = t(this).data(St),
                        r = "object" == typeof n && n;
                    if ((i || !/dispose|hide/.test(n)) && (i || (i = new e(this, r), t(this).data(St, i)), "string" == typeof n)) {
                        if (void 0 === i[n]) throw new TypeError('No method named "' + n + '"');
                        i[n]()
                    }
                })
    ...
    t.fn[xt] = Bt._jQueryInterface, t.fn[xt].Constructor = Bt, t.fn[xt].noConflict = function () {
        return t.fn[xt] = At, Bt._jQueryInterface
    };
    var Wt = "popover",
        $t = "bs.popover",
        Ut = "." + $t,
        ...
        Gt = function (e) {
            ...
            return r.isWithContent = function () {
                ...
                t(this.getTipElement()).addClass(Vt + "-" + e)
                ...
                return this.each(function () {
                    ...
                    if ((i || !/dispose|hide/.test(e)) && (i || (i = new n(this, r), t(this).data($t, i)), "string" == typeof e)) {
    ...
    t.fn[Wt] = Gt._jQueryInterface, t.fn[Wt].Constructor = Gt, t.fn[Wt].noConflict = function () {
        return t.fn[Wt] = zt, Gt._jQueryInterface
    };
    var Zt = "scrollspy",
        Jt = "bs.scrollspy",
        en = "." + Jt,
        ...
        fn = function () {
            function e(e, n) {
                var i = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(n), this._selector = this._config.target + " " + ln + "," + this._config.target + " " + cn + "," + this._config.target + " " + un, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, t(this._scrollElement).on(on.SCROLL, function (e) {
                    return i._process(e)
            ...
            return n.refresh = function () {
                var e = this,
                    n = this._scrollElement === this._scrollElement.window ? "offset" : dn,
                    i = "auto" === this._config.method ? n : this._config.method,
                    r = i === dn ? this._getScrollTop() : 0;
                ...
                t.removeData(this._element, Jt), t(this._scrollElement).off(en), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, n._getConfig = function (e) {
                if ("string" != typeof (e = o({}, nn, {}, "object" == typeof e && e ? e : {})).target) {
                    var n = t(e.target).attr("id");
                    n || (n = a.getUID(Zt), t(e.target).attr("id", n)), e.target = "#" + n
                }
                return a.typeCheckConfig(Zt, e, rn), e
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(sn), i.addClass(sn)) : (i.addClass(sn), i.parents(an).prev(ln + ", " + cn).addClass(sn), i.parents(an).prev(".nav-item").children(ln).addClass(sn)), t(this._scrollElement).trigger(on.ACTIVATE, {
                    relatedTarget: e
                })
            }, n._clear = function () {
                ...
                return this.each(function () {
                    var i = t(this).data(Jt);
                    if (i || (i = new e(this, "object" == typeof n && n), t(this).data(Jt, i)), "string" == typeof n) {
                        if (void 0 === i[n]) throw new TypeError('No method named "' + n + '"');
                        i[n]()
                    }
                })
    ...
    t(window).on(on.LOAD_DATA_API, function () {
        ...
        return t.fn[Zt] = tn, fn._jQueryInterface
    };
    var hn = "bs.tab",
        pn = "." + hn,
        mn = t.fn.tab,
        ...
        _n = function () {
            ...
            return n.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(vn) || t(this._element).hasClass("disabled"))) {
                    ...
                    if (r) {
                        var s = "UL" === r.nodeName || "OL" === r.nodeName ? bn : yn;
                        i = (i = t.makeArray(t(r).find(s)))[i.length - 1]
                    }
                    var l = t.Event(gn.HIDE, {
                            relatedTarget: this._element
                        }),
                        c = t.Event(gn.SHOW, {
                            relatedTarget: i
                ...
                t.removeData(this._element, hn), this._element = null
            }, n._activate = function (e, n, i) {
                function r() {
                    return o._transitionComplete(e, s, i)
                }
                var o = this,
                    s = (!n || "UL" !== n.nodeName && "OL" !== n.nodeName ? t(n).children(yn) : t(n).find(bn))[0],
                ...
                if (n) {
                    ...
                    r && t(r).removeClass(vn), "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !1)
                }
                if (t(e).addClass(vn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), a.reflow(e), e.classList.contains("fade") && e.classList.add("show"), e.parentNode && t(e.parentNode).hasClass("dropdown-menu")) {
                ...
                return this.each(function () {
                    var i = t(this),
                        r = i.data(hn);
                    if (r || (r = new e(this), i.data(hn, r)), "string" == typeof n) {
                        if (void 0 === r[n]) throw new TypeError('No method named "' + n + '"');
                        r[n]()
                    }
                })
    ...
    t(document).on(gn.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', function (e) {
        e.preventDefault(), _n._jQueryInterface.call(t(this), "show")
    }), t.fn.tab = _n._jQueryInterface, t.fn.tab.Constructor = _n, t.fn.tab.noConflict = function () {
        return t.fn.tab = mn, _n._jQueryInterface
    };
    var wn = "toast",
        En = "bs.toast",
        Cn = "." + En,
        ...
        In = function () {
            ...
            return n.show = function () {
                ...
                if (t(this._element).trigger(n), !n.isDefaultPrevented()) {
                    ...
                    var i = function () {
                        e._element.classList.remove(An), e._element.classList.add(Dn), t(e._element).trigger(xn.SHOWN), e._config.autohide && (e._timeout = setTimeout(function () {
                            e.hide()
                        }, e._config.delay))
                    };
                    if (this._element.classList.remove(Sn), a.reflow(this._element), this._element.classList.add(An), this._config.animation) {
                ...
                clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(Dn) && this._element.classList.remove(Dn), t(this._element).off(xn.CLICK_DISMISS), t.removeData(this._element, En), this._element = null, this._config = null
            }, n._getConfig = function (e) {
                return e = o({}, kn, {}, t(this._element).data(), {}, "object" == typeof e && e ? e : {}), a.typeCheckConfig(wn, e, this.constructor.DefaultType), e
            }, n._setListeners = function () {
                var e = this;
                ...
                function e() {
                    n._element.classList.add(Sn), t(n._element).trigger(xn.HIDDEN)
                }
                var n = this;
    ...
    t.fn[wn] = In._jQueryInterface, t.fn[wn].Constructor = In, t.fn[wn].noConflict = function () {
        return t.fn[wn] = Tn, In._jQueryInterface
    }, e.Alert = h, e.Button = T, e.Carousel = M, e.Collapse = Z, e.Dropdown = ot, e.Modal = _t, e.Popover = Gt, e.Scrollspy = fn, e.Tab = _n, e.Toast = In, e.Tooltip = Bt, e.Util = a, Object.defineProperty(e, "__esModule", {
        value: !0
    })
}),
function (e) {
    ...
    e.extend(e.fn, {
        ...
        prototype: {
            ...
            elementValue: function (t) {
                var n, i, r = e(t),
                    o = t.type;
                return "radio" === o || "checkbox" === o ? this.findByName(t.name).filter(":checked").val() : "number" === o && void 0 !== t.validity ? t.validity.badInput ? "NaN" : r.val() : (n = t.hasAttribute("contenteditable") ? r.text() : r.val(), "file" === o ? "C:\\fakepath\\" === n.substr(0, 12) ? n.substr(12) : (i = n.lastIndexOf("index.html")) >= 0 ? n.substr(i + 1) : (i = n.lastIndexOf("\\")) >= 0 ? n.substr(i + 1) : n : "string" == typeof n ? n.replace(/\r/g, "") : n)
            },
            check: function (t) {
    ...
    $(".collapsible").on("click", function () {
        $(this).parent().find(".collapse").collapse("hide"), $(this).next().collapse("toggle")
    })
});
var Strut = {
...
Strut.isRetina = window.devicePixelRatio > 1.3, Strut.mobileViewportWidth = 670, Strut.isMobileViewport = window.innerWidth < Strut.mobileViewportWidth, window.addEventListener("resize", function () {
    ...
    positionSticky: function () {
        ...
        return n.cssText = e + i.join(t + ";" + e).slice(0, -e.length), -1 !== n.position.indexOf(t)
    }(),
    ...
    if (!Strut.isMobileViewport)
        if (1 == e.compact) {
            ...
            var i = e.primaryNavItem.getBoundingClientRect(),
                r = e.secondaryNavItem.getBoundingClientRect();
            i.right > r.left && (e.container.classList.add("compact"), e.compact = !0)
        }
    ...
    if (this.activeDropdown !== e) {
        ...
        var n, i, r, o = e.getAttribute("data-dropdown"),
            s = "left";
        this.dropdownSections.forEach(function (e) {
            e.el.classList.remove("active"), e.el.classList.remove("left"), e.el.classList.remove("right"), e.name == o ? (e.el.classList.add("active"), s = "right", n = e.content.offsetWidth, i = e.content.offsetHeight, r = e.content) : e.el.classList.add(s)
        });
        var a = n / 520,
            l = i / 400,
            c = e.getBoundingClientRect(),
            u = c.left + c.width / 2 - n / 2;
        ...
        }, 50), this.dropdownBackground.style.transform = "translateX(" + u + "px) scaleX(" + a + ") scaleY(" + l + ")", this.dropdownContainer.style.transform = "translateX(" + u + "px)", this.dropdownContainer.style.width = n + "px", this.dropdownContainer.style.height = i + "px";
        var d = Math.round(c.left + c.width / 2);
        this.dropdownArrow.style.transform = "translateX(" + d + "px) rotate(45deg)";
        var f = r.children[0].offsetHeight / l;
        this.dropdownBackgroundAlt.style.transform = "translateY(" + f + "px)"
    }
}, globalNavDropdowns.prototype.closeDropdown = function () {
    var e = this;
    this.activeDropdown && (this.dropdownRoots.forEach(function (e, t) {
        e.classList.remove("active")
    }), clearTimeout(this.enableTransitionTimeout), this.disableTransitionTimeout = setTimeout(function () {
        e.container.classList.add("noDropdownTransition")
    }, 50), this.container.classList.remove("overlayActive"), this.container.classList.remove("dropdownActive"), this.activeDropdown = void 0)
    ...
    null !== document.querySelector(".navbar") && (new globalNavDropdowns(".navbar"), new globalNavPopup(".navbar .navSection.mobile"))
});
var NAV_XHR, handleAppNotification = function () {
    $.extend({
        notification: function (e) {
            var t = e.title ? e.title : "",
                n = e.content ? e.content : "",
                i = e.icon ? e.icon : "",
                r = e.iconClass ? e.iconClass : "",
                o = e.img ? e.img : "",
                s = e.imgClass ? e.imgClass : "",
                a = e.closeBtn ? e.closeBtn : "",
                l = (e.closeBtnText && e.closeBtnText, e.btn ? e.btn : ""),
                c = e.btnText ? e.btnText : "",
                u = e.btnAttr ? e.btnAttr : "",
                d = e.btnUrl ? e.btnUrl : "#",
                f = e.btnClick ? ' onclick="' + e.btnClick + '"' : "",
                h = e.autoclose ? e.autoclose : "",
                p = e.autocloseTime ? e.autocloseTime : 5e3,
                m = t ? '<h4 class="notification-title">' + t + "</h4>" : "",
                g = n ? '<p class="notification-desc">' + n + "</p>" : "",
                v = i ? '<div class="notification-media"><i class="' + i + " " + r + '"></i></div>' : "",
                y = l && c ? '<a href="' + d + '"' + f + " " + u + ">" + c + "</a>" : "",
                b = a && "disabled" == a ? "" : '<a href="#" data-dismiss="notification">Close</a>',
                _ = '<div class="page-notification ' + (e.class ? e.class : "") + " bounceInRight animated " + (e.inverseMode ? "page-notification-inverse" : "") + '">' + (v = o ? '<div class="notification-media"><img src="' + o + '" class="' + s + '"></i></div>' : v) + (m || g ? '<div class="notification-info">' + m + g + "</div>" : "") + ('<div class="notification-btn ' + (!y && b || y && !b ? "single-btn" : "") + '">' + y + b + "</div>") + "</div>";
            if (0 === $("#page-notification-container").length && $("body").append('<div id="page-notification-container" class="page-notification-container"></div>'), $("#page-notification-container").append(_), h) {
                var w = $("#page-notification-container").find(".page-notification").last();
                setTimeout(function () {
                    $(w).fadeOut(function () {
                        $(this).remove()
                    })
...
function ajax_message(e) {
    $.ajax({
        type: "POST",
        url: "/ajax/test/",
        cache: !1,
        success: function (e) {
            $("#message_container").html(e)
        }
    })
}

function show_me_message(e, t) {
    $.notification({
        title: 2 == t ? "" : "Service message",
        content: e,
        btn: !0,
        autoclose: !0,
        autocloseTime: 6e3
...
function nav_open_chat(e) {
    var t = parseInt($(".msg-refresh:first").text(), 10) - e;
    return t = t > 0 ? t : "", $(".msg-refresh").text(t), !1
}

function dropNotifCurrency(e) {
    var t = $("#nav-currency");
    0 == t.find("ul").html().length && (t.find("ul").html('<li class="loading center"><i class="fa fa-spin fa-circle-o-notch grey"></i></li>'), $.ajax({
        url: e + "/profile/notification-currency/",
        success: function (e) {
            t.find("ul").html(e), t.find("li > a").on("click", function () {
                t.find(".dropdown-toggle").button("loading"), $.ajax({
...
function dropNotifMsg(e) {
    NAV_XHR && 4 != NAV_XHR.readystate && NAV_XHR.abort();
    var t = $("#nav-msg");
    t.find(".fa-sync-alt").addClass("fa-spin"), t.find("ul > li, .loading").not(".dropdown-header, .dropdown-footer").remove(), t.find("ul > li.dropdown-header").after('<li class="loading center"><i class="fa fa-spin fa-circle-o-notch grey"></i></li>'), NAV_XHR = $.ajax({
        url: e + "/profile/notification-message/",
        success: function (e) {
            t.find(".fa-sync-alt").removeClass("fa-spin"), t.find("ul > li, .loading").not(".dropdown-header, .dropdown-footer").remove(), t.find("ul > li.dropdown-header").after(e)
        }
    })
}
...
function setCookie(e, t, n) {
    ...
    document.cookie = o + "; SameSite=Strict"
}
$(document).ready(function () {
    handleAppNotification(), $(document.body).on("click", ".dropdown-stop", function (e) {

...
/* harmony import */ var _modules_navigation__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/navigation */ "./resources/js/js/modules/navigation.js");
/* harmony import */ var _modules_input__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/input */ "./resources/js/js/modules/input.js");
/* harmony import */ var _modules_select__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/select */ "./resources/js/js/modules/select.js");
...
/***/ "./resources/js/js/modules/datepicker.js":
/*!***********************************************!*\
  !*** ./resources/js/js/modules/datepicker.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony import */ var air_datepicker_locale_en__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(air_datepicker_locale_en__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  calendars.forEach(function (calendar) {
    ...
    var initDesktopDatepicker = function initDesktopDatepicker() {
      if (datepicker) datepicker.destroy();
      datepicker = new air_datepicker__WEBPACK_IMPORTED_MODULE_0__["default"](calendar, {
        ...
        position: function position(_ref) {
          ...
          var top = coords.y - 2;
          var left = coords.x + coords.width - dpWidth + 2;
    ...
    var initMobileDatepicker = function initMobileDatepicker() {
      if (datepicker) datepicker.destroy();
      datepicker = new air_datepicker__WEBPACK_IMPORTED_MODULE_0__["default"](calendar, {
        locale: air_datepicker_locale_en__WEBPACK_IMPORTED_MODULE_1___default.a,
        selectedDates: [new Date()],
    ...
    var handleWindowResizing = function handleWindowResizing() {
...
/***/ "./resources/js/js/modules/input.js":
/*!******************************************!*\
  !*** ./resources/js/js/modules/input.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var inputs = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.input__holder input, .input__holder textarea');
  if (!inputs.length) return;
  var close = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.input__holder button');
  inputs.on('focus', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent('.input__holder').addClass('active');
  });
  inputs.on('blur', function () {
    if (!jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length > 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent('.input__holder').removeClass('active');
    }
  });
  inputs.on('input', function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length > 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent('.input__holder').addClass('filled');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent('.input__holder').removeClass('filled');
    }
  });

  if (close.length) {
    close.on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('input').val('');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parent('.input__holder').removeClass('filled').removeClass('active');
    });
  }
});
...
/***/ "./resources/js/js/modules/navigation.js":
/*!***********************************************!*\
  !*** ./resources/js/js/modules/navigation.js ***!
  \***********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  var navigation = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__wrapper');
  ...
  function addNavigationHandler() {
    ...
    navigation.on('click', '.main-menu__item.parent .main-menu__link', function (e) {
      e.preventDefault();
      var subMenu = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).next('.main-menu__sub');
  ...
  function removedNavigationHandler() {
    navigation.off();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.main-menu__sub').removeAttr('style');
  ...
  handleWindowResizing();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).on('resize', handleWindowResizing);
});

/***/ }),

/***/ "./resources/js/js/modules/route.js":
/*!******************************************!*\
  !*** ./resources/js/js/modules/route.js ***!
  \******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var routes = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.form__routes');
  if (!routes.length) return;
  routes.on('change', 'input', function () {
    var form = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).parents('form');
    var activeRoute = form.find(jquery__WEBPACK_IMPORTED_MODULE_0___default()('.route.active'));
    var route = form.find(jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-route=".concat(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val(), "]")));
    var routeRadio = route.find('input');
    var routeSelect = route.find('select');
    ...
    if (routeSelect.length) {
      routeSelect.find(jquery__WEBPACK_IMPORTED_MODULE_0___default()('option:first')).attr('selected', true);
...
/***/ "./resources/js/js/modules/select.js":
/*!*******************************************!*\
  !*** ./resources/js/js/modules/select.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var selects = jquery__WEBPACK_IMPORTED_MODULE_0___default()('select');
...
/***/ "./resources/js/js/modules/tabs.js":
/*!*****************************************!*\
  !*** ./resources/js/js/modules/tabs.js ***!
  \*****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var tabs = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tabs');
  if (!tabs.length) return;

  var setTabs = function setTabs(elem) {
    elem.addClass('active').siblings().removeClass('active').parents('.tabs').find('.tabs__block').removeClass('active').eq(elem.index()).addClass('active');
  };
...
/***/ 0:
/*!*****************************************************************!*\
  !*** multi ./resources/js/js/main.js ./resources/sass/app.scss ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
